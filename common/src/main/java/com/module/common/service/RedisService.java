package com.module.common.service;
...
public class RedisService {
    ...
    public void verifyPaymentCompletion(String hashKey) {
        ...
        if (PaymentStatus.COMPLETED.getCode().equals(status)) {
    ...
    public void acquireLock(String hashKey) {
        Boolean lockAcquired = redisTemplate.opsForValue().setIfAbsent(hashKey + ":lock", PaymentStatus.LOCKED.getCode(), expiryMinutes, TimeUnit.MINUTES);
